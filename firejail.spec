...
# Source0-md5:	cd6d083ca88b452fb6cde73b64a8fb70
...
%attr(755,root,root) %{_bindir}/jailcheck
%attr(755,root,root) %{_libdir}/firejail/firejail-welcome.sh
%attr(755,root,root) %{_libdir}/firejail/fj-mkdeb.py
%attr(755,root,root) %{_libdir}/firejail/gdb-firejail.sh
%attr(755,root,root) %{_libdir}/firejail/jail_prober.py
%{_libdir}/firejail/seccomp.mdwx.32
%attr(755,root,root) %{_libdir}/firejail/update_deb.sh
%{_mandir}/man1/jailcheck.1*
%{_datadir}/vim/vimfiles/ftdetect/firejail.vim
%{_datadir}/vim/vimfiles/syntax/firejail.vim
%{zsh_compdir}/_firejail
